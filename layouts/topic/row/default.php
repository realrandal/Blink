	...
	<div class="topic-info">		
		...
		<header class="topic-desc">		
					<h4 class="category-topic-title">
						...
						<?php echo $this->getCategoryLink($topic->getCategory(), null, null, 'uk-tip uk-text-small uk-link-muted'); ?>
...
$('.have-replies .react-please-<?php echo $topic->id?>').html( randno );
});
});
</script>
...
<div class="last-reply-info no-reply-info">	
		<div class="uk-text-muted uk-float-left uk-text-small no-replies-info">  
			<span class="react-please-<?php echo $topic->id?>"><?php echo $hits; ?> odsłon</span> 
		</div>
