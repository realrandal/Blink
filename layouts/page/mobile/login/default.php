...
<ul class="nav pull-left">
	<li class="dropdown">
		<a href="#" class="uk-button btn-small mobile btn-navbar" data-toggle="dropdown">
		...
		<div class="dropdown-menu uk-panel-box">
			<form action="<?php echo JRoute::_('index.php?option=com_kunena'); ?>" method="post" class="form-inline">
				...
				<div id="form-login-submit" class="control-group center">
					<p>
						<button type="submit" tabindex="3" name="Submit" class="uk-button btn-primary btn"><?php echo JText::_('JLOGIN') ?></button>
					</p>
