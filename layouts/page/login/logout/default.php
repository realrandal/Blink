	...
	<li class="dropdown">
		...
		<div class="dropdown-menu uk-panel-box">
			<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena'); ?>" method="post" id="logout-form" class="form-inline">
				...
				<div>
					<a href="<?php echo $this->announcementsUrl; ?>" class="uk-button btn-small btn-link">
				...
				<div>
					<a href="<?php echo $this->pm_link; ?>" class="uk-button btn-small btn-link">
						<i class="icon-mail"></i>
				...
				<div>
					<a href="<?php echo $this->me->getUrl(false, 'edit'); ?>" class="uk-button btn-small btn-link">
						<i class="icon-cog"></i>
				...
				<a href="<?php echo $markAllReadUrl; ?>" class="uk-button btn-small btn-link">
					<i class="icon-out"></i>
					<?php echo JText::_('COM_KUNENA_MARK_ALL_READ'); ?>
				</a>
				<?php endif ?>

				<button class="uk-button btn-small btn-link" name="submit" type="submit">
					<i class="icon-out"></i>
