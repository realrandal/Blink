...
<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=search'); ?>" method="post">
	...
	<div class="uk-button btn-small pull-right" data-toggle="collapse" data-target="#search">&times;</div>
	<h2>
	...
	<div class="collapse in" id="search">
		...
		<div class="uk-button btn-small pull-right" data-toggle="collapse" data-target="#search-options">&times;</div>
		<h3>
		...
		<div class="center">
			<input class="uk-button btn-primary" type="submit" value="<?php echo JText::_('COM_KUNENA_SEARCH_SEND'); ?>" />
			<input class="uk-button" type="reset" value="<?php echo JText::_('COM_KUNENA_CANCEL'); ?>"
